...
const WA_NUMBER = '918799008221';
const PHONE_NUMBER = '8799008221';
    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center sm:text-left">
      ...
      <div>
        ...
        <ul className="text-sm text-[#D9C4B0] space-y-1">
          ...
          <li>
            <a href={`tel:${PHONE_NUMBER}`} className="hover:text-[#D4AF37] transition">
              📞 {PHONE_NUMBER}
            </a>
          </li>
        </ul>
      ...
      <div>
        ...
        <div className="flex justify-center sm:justify-start gap-4 mt-2">
          <a href={`https://wa.me/${WA_NUMBER}`} target="_blank" rel="noreferrer" aria-label="WhatsApp"
