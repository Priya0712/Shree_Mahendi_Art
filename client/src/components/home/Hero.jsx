const Hero = () => (
  <section className="relative bg-gradient-to-b from-[#FFF3E0] to-[#FFF8F0] overflow-hidden">
    {/* Decorative mehendi paisley pattern - low opacity SVG background */}
    ...
    <div className="relative max-w-6xl mx-auto px-4 py-12 md:py-20 flex flex-col md:flex-row items-center gap-8">
      ...
      <div className="flex-1 w-full">
        {/* Hero image - bridal mehendi hand close-up */}
        <img src="/images/hero-bridal-mehendi.jpg" alt="બ્રાઇડલ મહેંદી ડિઝાઈન"
          className="w-full h-64 sm:h-80 md:h-96 object-cover rounded-3xl shadow-xl" loading="eager" />
      </div>
    </div>
  </section>
);
